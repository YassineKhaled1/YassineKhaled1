...
![Repo size](https://img.shields.io/github/repo-size/yassinekhaled/ProfessorPhoenix)
...
- تركيب محطات إنترنت (هاردوير + سوفتوير)  
- أنظمة حماية وكاميرات للمنازل والشركات  
- فهم عميق لـ: **IP, MAC, Subnet, Gateway, DNS, Firewall**
...
- Digital Activism: Founder of ProfessorPhoenix, leader of independent media team  

---

> 💡 Technology is not just tools — it's a path to freedom and building a more conscious, empowered society.
